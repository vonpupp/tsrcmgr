...
setup(
    name='tsrcmgr',
    description="A manager for bulk repositories management on tsrc",
    ...
    url= 'https://github.com/vonpupp/tsrcmgr',
    download_url=(
        f'https://github.com/vonpupp/'
        f'tsrcmgr/archive/{version}.tar.gz'
    ),
    keywords=[
